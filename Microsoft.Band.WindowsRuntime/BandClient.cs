...
namespace Microsoft.Band.WindowsRuntime
{
          ...
          IBandTileManager
    {
        ...
        IBandGsrSensor IBandSensorManager.Gsr
        {
            get
            {
                return this.gsr.Value;
            }
        }

        IBandGyroscopeSensor IBandSensorManager.Gyroscope
        {
            get
            {
                return this.gyroscope.Value;
            }
        }

        IBandHeartRateSensor IBandSensorManager.HeartRate
        {
            get
            {
        ...
        IBandRRIntervalSensor IBandSensorManager.RRInterval
        {
            get
            {
                return this.rrInterval.Value;
            }
        }

        IBandSkinTemperatureSensor IBandSensorManager.SkinTemperature
        {
            get
            {
